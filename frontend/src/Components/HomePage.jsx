            ...
            <div className="w-[70%] flex flex-col items-center justify-center h-full">
              <div className="max-w-[70%] text-center">
                <img
                  ...
                  src="/HomePageImg.png"
                  alt="chatApplication-icon"
                />
                <h1 className="text-4xl text-gray-600">chatApplication Web</h1>
                ...
                <div className="flex justify-between">
                  <div className="py-3 space-x-4 flex items-center px-3">
                    <img
                      ...
                      src={
                        currentChat.group
                          ? currentChat.chat_image || defaultImage
                          : otherUser?.profile || defaultImage
                            }
                      alt="profile"
                    />
                    <p>
